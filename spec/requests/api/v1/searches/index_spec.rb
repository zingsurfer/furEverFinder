...
describe 'GET /api/v1/searches', type: :request do
  ...
  context 'without data' do
    ...
    context 'when invalid' do
      it 'errors for an invalid param key' do
      ...
      it 'errors for invalid param keys' do
        valid_param = 'ordered_by'
        valid_value = 'newist'
        invalid_key_1 = 'kiwi'
        invalid_key_2 = 'mango'
      ...
      it 'errors for an unsupported param combo' do
      ...
      it 'errors for an invalid ordered_by param value' do
      ...
      it 'errors for an invalid sorted_by_topic param value' do
  ...
  context 'with data' do
    ...
    context 'when valid' do
      ...
      it 'returns searches ordering by newist' do
      ...
      it 'returns searches ordering by oldest' do
    ...
    context 'when invalid' do
      ...
      it 'errors for currently unsupported param combinations' do
        get "/api/v1/searches?sorted_by_topic=true&ordered_by=newist_created"
